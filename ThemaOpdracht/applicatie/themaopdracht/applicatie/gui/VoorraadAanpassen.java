...
import themaopdracht.applicatie.controller.ProductAanpassenControler;
...
public class VoorraadAanpassen extends BorderPane {
	private VBox invulLijst, tekstLijst;
	private Button annuleren, controleerAantallen;
	private HBox buttons;
	private TextField aantalStukstf;

	public VoorraadAanpassen(KnoppenMenu km, Stage owner, Product product) {
		ProductAanpassenControler controler = new ProductAanpassenControler(km);
		Label productLabel = new Label("Product:");
		Label artikelnummer = new Label("productnummer:");
		Label aantalAanwezig = new Label("Aantal op voorraad");
		Label aantalStuks = new Label("Nieuw aantal stuks:");
