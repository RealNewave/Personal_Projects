...
import themaopdracht.applicatie.controller.VoorraadAanpassenSelecteerContr;
...
public class VoorraadAanpassenSelecteer extends BorderPane {
	private HBox buttons, hb;
	private CheckBox cb1, cb2;
	private ComboBox<Product> productcb;
	private ComboBox<Brandstof> brandstofcb;
	private Button annuleren, verder;
	private VoorraadAanpassenSelecteerContr controller;
	
	public VoorraadAanpassenSelecteer(KnoppenMenu km, Stage owner, Voorraad v) {
		controller = new VoorraadAanpassenSelecteerContr(v);
